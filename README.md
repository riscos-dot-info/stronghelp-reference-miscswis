StrongHelp Misc SWIs Reference Manual
=====================================

This project contains the source files for the StrongHelp Misc SWIs reference manual [hosted on riscos.info](http://www.riscos.info/downloads/stronghelp/manuals/).
